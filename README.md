...
My implementation and the version released by the authors is very different in structure as well as in the use of libraries. My implementation uses PyTorch and their implementation uses TensorFlow.
